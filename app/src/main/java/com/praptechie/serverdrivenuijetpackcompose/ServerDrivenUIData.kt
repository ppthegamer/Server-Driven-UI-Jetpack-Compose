...
data class ContentData(val text: String?=null,val imageUrl: String?=null,val url: String?=null)

data class ActionData(val perform:String?=null,val parameters: ActionParameters?=null)

data class ColumnStyle(val verticalArrangement: String?=null,val horizontalAlignment:String?=null)
data class RowStyle(val horizontalArrangement: String?=null,val verticalAlignment:String?=null)
